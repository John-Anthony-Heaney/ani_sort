...
# source("path_to_your_function/bubble_sort_steps.R")

test_that("bubble_sort_steps sorts correctly", {
  set.seed(123) # Setting seed for reproducibility
  N <- 5
  result <- bubble_sort_steps(N)
...
test_that("bubble_sort_steps returns a matrix", {
  N <- 5
  result <- bubble_sort_steps(N)
...
test_that("bubble_sort_steps handles edge cases", {

  # Test with N = 1 (only one element to sort)
  result_one <- bubble_sort_steps(1)
